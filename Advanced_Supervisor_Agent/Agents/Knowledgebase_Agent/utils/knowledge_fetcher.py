...
from Agents.Knowledgebase_Agent.utils.prompts import qrc_knowledgebase_system_message, current_date_prompt,chart_message
...
def data_fetcher(query):
    ...
    if len(response) ==0 :
        return "no records available into database for given query"
